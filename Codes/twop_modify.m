function twop_modify(g_modify,v_org,cons_org)
close all
clc
...
%% ALTERNATE CHECK function
    function [B_indices B bstar iter A2 c2 f rowname1 iter_total dat1 U_indices U_indices_new U_id] = alternate_check(A1,B, bstar, B_indices, V_indices, m,ent_var_mat,u,n,A2,minimize,iter,c2,f,b,c1,ent_var_index,art_indices,surp,rowname1,iter_total,total,dat1,U_indices,U_indices_new,U_id)
        ...
        while (1==1)       
           ...
           if art_inf == 1000
            ...
            if min(ent_var_mat) >= 0                                      %% Optimality condition satisfied
              ...
              [B_indices B bstar iter A2 c2 f rowname1 iter_total dat1 U_indices U_indices_new U_id] = alternate_check(A1,B, bstar, B_indices, V_indices, m,ent_var_mat,u,n,A2,minimize,iter,c2,f,b,c1,ent_var_index,art_indices,surp,rowname1,iter_total,total,dat1,U_indices,U_indices_new,U_id);           %% Check for ALTERNATE SOLUTIONS
